...
<div className="  grid grid-cols-3 gap-8 ">
  {calculation.map((item, index) => (
    <div
      key={index}
      className="bg-[#111B3C]  p-6 rounded-xl"
    >
      <section className=" space-y-2 ">
       ...
       <div className=" py-2 rounded bg-linear-to-t from-[#1A1A2E] to-[#16213E]">
         ...
         <div className="flex items-center "> 
            <input type="text" Value="https://techstore.com/book?id=store123" className=" w-full rounded-md bg-[#1a2942] px-4 py-2" />
             <button className=" px-2 py-2 border"> <FaRegCopy /> <span>Copy Link</span></button> 
